...
void Credits(bool* p_open)
{
	ImGui::SetNextWindowSize(ImVec2(520, 200), ImGuiCond_FirstUseEver);
	if (!ImGui::Begin("Credits", p_open, ImGuiWindowFlags_AlwaysAutoResize))
	{
		ImGui::End();
		return;
	}

	ImGui::Text("RussellJerome - Creator of Unreal Mod Loader");
	ImGui::Spacing();
	ImGui::Separator();
	ImGui::Spacing();
	if (ImGui::TreeNode("3rd Party Software")) {
		ImGui::BulletText("feather-ini-parser");
...
void DrawImGui()
{
	...
	ImGui::Spacing();
	ImGui::TextColored(ImVec4(1.0f, 1.0f, 0.0f, 1.0f), "Author of UML: RussellJerome");
	ImGui::TextColored(ImVec4(1.0f, 1.0f, 0.0f, 1.0f), "Edited by Redacted_xd");
	ImGui::Spacing();
	if (ImGui::TreeNode("3rd Party Software")) {
		ImGui::BulletText("feather-ini-parser");
		ImGui::BulletText("Minhook");
...
void LoaderUI::LoaderD3D11Present(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
{
	...
	{
		//ImGuiIO& io = ImGui::GetIO();
		//io.Fonts->AddFontFromFileTTF("ImGui/OpenSans-Regular.ttf", 14);
		...
		*/
		...
		colors[ImGuiCol_Text] = ImVec4(0.85f, 0.86f, 0.92f, 1.00f);
		colors[ImGuiCol_TextDisabled] = ImVec4(0.85f, 0.86f, 0.92f, 0.58f);
		colors[ImGuiCol_WindowBg] = ImVec4(0.06f, 0.06f, 0.08f, 1.00f);
		//style.Colors[ImGuiCol_ChildWindowBg] = ImVec4(0.16f, 0.18f, 0.31f, 0.00f);
		colors[ImGuiCol_PopupBg] = ImVec4(0.05f, 0.05f, 0.10f, 0.90f);
		colors[ImGuiCol_Border] = ImVec4(0.85f, 0.86f, 0.92f, 0.30f);
		colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
		colors[ImGuiCol_FrameBg] = ImVec4(0.16f, 0.18f, 0.31f, 1.00f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.19f, 0.24f, 0.63f, 0.68f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.19f, 0.24f, 0.63f, 1.00f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.19f, 0.24f, 0.63f, 0.45f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.19f, 0.24f, 0.63f, 0.35f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.19f, 0.24f, 0.63f, 0.78f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.16f, 0.18f, 0.31f, 0.57f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.16f, 0.18f, 0.31f, 1.00f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.19f, 0.24f, 0.63f, 0.31f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.19f, 0.24f, 0.63f, 0.78f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.19f, 0.24f, 0.63f, 1.00f);
		//style.Colors[ImGuiCol_ComboBg] = ImVec4(0.16f, 0.18f, 0.31f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.19f, 0.24f, 0.63f, 0.80f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.19f, 0.24f, 0.63f, 0.24f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.19f, 0.24f, 0.63f, 1.00f);
		colors[ImGuiCol_Button] = ImVec4(0.19f, 0.24f, 0.63f, 0.44f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.19f, 0.24f, 0.63f, 0.86f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.19f, 0.24f, 0.63f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(0.19f, 0.24f, 0.63f, 0.76f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.19f, 0.24f, 0.63f, 0.86f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.19f, 0.24f, 0.63f, 1.00f);
		//style.Colors[ImGuiCol_Column] = ImVec4(0.85f, 0.86f, 0.92f, 0.32f);
		//style.Colors[ImGuiCol_ColumnHovered] = ImVec4(0.85f, 0.86f, 0.92f, 0.78f);
		//style.Colors[ImGuiCol_ColumnActive] = ImVec4(0.85f, 0.86f, 0.92f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.19f, 0.24f, 0.63f, 0.20f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.19f, 0.24f, 0.63f, 0.78f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.19f, 0.24f, 0.63f, 1.00f);
		//style.Colors[ImGuiCol_CloseButton] = ImVec4(0.85f, 0.86f, 0.92f, 0.16f);
		//style.Colors[ImGuiCol_CloseButtonHovered] = ImVec4(0.85f, 0.86f, 0.92f, 0.39f);
		//style.Colors[ImGuiCol_CloseButtonActive] = ImVec4(0.85f, 0.86f, 0.92f, 1.00f);
		colors[ImGuiCol_PlotLines] = ImVec4(0.85f, 0.86f, 0.92f, 0.63f);
		colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.19f, 0.24f, 0.63f, 1.00f);
		colors[ImGuiCol_PlotHistogram] = ImVec4(0.85f, 0.86f, 0.92f, 0.63f);
		colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.19f, 0.24f, 0.63f, 1.00f);
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.19f, 0.24f, 0.63f, 0.43f);
